...
const experience = [
  ...
  { date: '2022.06 — 2023.08', company: '深圳三快网络科技有限公司', role: '外卖部门 Business Development', intro: '拓展并维护区域新老商户，解决商家与消费者问题，为经营指标和长期合作关系负责。', result: '深圳新人 PK 赛第一名；月度区域 271 考核稳定前 30%；夏季战役第三名，季度考核最高第四名。' },
...
function App() {
  ...
  return <main>
    ...
    <section className="contact" id="contact"><div className="contact-bg"/><div className="wrap contact-wrap"><div className="section-tag reveal"><span>04</span> CONTACT</div><div className="contact-copy reveal"><p>下一段增长，从一次真诚的交流开始。</p><h2>期待与你<br/><em>合作</em></h2></div><div className="contact-socials reveal"><BorderGlow className="social-glow" edgeSensitivity={24} glowColor="24 100 58" backgroundColor="#0b0d0d" borderRadius={22} glowRadius={28} glowIntensity={1.1} coneSpread={24} animated={true} colors={["#ff6a00", "#ffb15c", "#ffffff"]} fillOpacity={0.16}><img src="/social-accounts-combined.png" alt="抖音、小红书和视频号账号二维码"/></BorderGlow></div><div className="contact-actions reveal"><a href="tel:18594204546"><span>电话</span><b>185 9420 4546</b><ArrowUpRight/></a><a href="mailto:10615961@qq.com"><span>邮箱</span><b>10615961@qq.com</b><ArrowUpRight/></a></div><footer><span>© 2026 WEI MINGHAO</span><span>ALIBABA.COM ACCOUNT MANAGER · SHENZHEN</span></footer></div></section>
  </main>
}
